page 80001 "Bank Account Ledger Entry CBR"
{
    ApplicationArea = All;
    Caption = 'Bank Account Ledger Entries CBR';
    DataCaptionFields = "Bank Account No.";
    DeleteAllowed = false;
    Editable = true;
    InsertAllowed = true;
    PageType = List;
    Permissions = tabledata 271 = rmid;
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action("CBR Reset Lines")
                {
                    ...
                    Begin
                        IF NOT CONFIRM(' Do you want to rest the selected Bank Acc. Ledger Entry record', FALSE) THEN
                            EXIT;
                        TESTFIELD(Open, TRUE);
